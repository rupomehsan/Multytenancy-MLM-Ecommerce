...
namespace App\Modules\Inventory\Managements\SupplyerType\Controllers;

use App\Http\Controllers\Controller;
use App\Http\Controllers\Outlet\Models\SupplierSourceType;
use Carbon\Carbon;
...
class SupplierSourceController extends Controller
{
    ...
    {
        return view('backend.supplier_source.create');
    }
    ...
    public function viewAllSupplierSource(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    $btn = ' <a href="' . url('edit/supplier-source') . '/' . $data->slug . '" class="btn-sm btn-warning rounded editBtn"><i class="fas fa-edit"></i></a>';
        ...
        return view('backend.supplier_source.view');
    }
    ...
    public function editSupplierSource($slug)
    {
        ...
        return view('backend.supplier_source.edit', compact('data'));
    }
