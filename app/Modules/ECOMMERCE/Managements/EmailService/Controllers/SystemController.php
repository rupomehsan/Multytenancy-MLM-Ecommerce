...
namespace App\Modules\ECOMMERCE\Managements\EmailService\Controllers;
...
class SystemController extends Controller
{
    ...
    {
        $this->loadModuleViewPath('ECOMMERCE/Managements/EmailService');
    }
