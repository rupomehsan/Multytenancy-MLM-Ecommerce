...
Route::group(['middleware' => ['auth', 'CheckUserType', 'DemoMode']], function () {
    ...
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/Configurations/Routes/Web.php';
    // brand
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ProductAttributes/Brands/Routes/Web.php';
    // model
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ProductAttributes/Models/Routes/Web.php';
    // config routes for falg
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ProductAttributes/Flags/Routes/Web.php';
    // config routes for unit
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ProductAttributes/Units/Routes/Web.php';
    // colors
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ProductAttributes/Colors/Routes/Web.php';
    // config routes for sizes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ProductAttributes/Sizes/Routes/Web.php';
    // category routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/Categories/Routes/Web.php';
    // subcategory routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/SubCategories/Routes/Web.php';
    // childcategory routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/ChildCategories/Routes/Web.php';
    // product routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/ProductManagements/Products/Routes/Web.php';
    ...
    // order routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/Orders/Routes/Web.php';
    // payment history routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/PaymentHistory/Routes/Web.php';
    // pos routes
    ...
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/POS/Routes/Web.php';
    // promo codes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/PromoCodes/Routes/Web.php';
    // wishlist routes
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/CutomerWistList/Routes/Web.php';
    // push notification
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/PushNotification/Routes/Web.php';
    // delivery charges
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/DeliveryCharges/Routes/Web.php';
    // generate report
    require __DIR__ . '/../app/Modules/ECOMMERCE/Managements/Reports/Routes/Web.php';
