...
require __DIR__ . '/../Managements/Referral/Routes/Web.php';
require __DIR__ . '/../Managements/Reports/Routes/Web.php';
require __DIR__ . '/../Managements/TopEarners/Routes/Web.php';
require __DIR__ . '/../Managements/PassiveIncome/Routes/Web.php';
