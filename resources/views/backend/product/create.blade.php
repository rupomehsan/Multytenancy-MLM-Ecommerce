                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="low_stock" name="low_stock" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="size_ratio" name="size_ratio" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="fabrication_gsm_ounce" name="fabrication_gsm_ounce"
                                        class="form-control" placeholder="Enter Fabrication GSM/Ounce">
                                    <div class="invalid-feedback" style="display: block;">
