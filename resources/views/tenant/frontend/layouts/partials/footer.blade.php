        ...
        <div class="container-fluid">
            <div class="main__footer d-flex justify-content-between">
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner">
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/customer/home') }}">My Account</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/my/orders') }}">My orders</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/my/wishlists') }}">My wishlist</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/my/payments') }}">Payment
                                history</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/support/tickets') }}">Support
                                tickets</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text"
                                href="{{ url('/promo/coupons') }}">Promo/Coupons</a>
                        </li>
                        ...
                        @guest
                            <li class="footer__widget--menu__list">
                                <a class="footer__widget--menu__text" href="{{ route('login') }}">Login</a>
                            </li>
                        @endguest
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner">
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/about') }}">About</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/blogs') }}">Blog</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/contact') }}">Contact</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/terms/of/services') }}">Terms of
                                Services</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/privacy/policy') }}">Privacy
                                Policy</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/refund/policy') }}">Refund
                                Policy</a>
                        </li>
                        <li class="footer__widget--menu__list">
                            <a class="footer__widget--menu__text" href="{{ url('/shipping/policy') }}">Shipping
                                Policy</a>
                        </li>
                        <li class="footer__widget--menu__list">
                ...
                <div class="footer__widget footer__widget--width col-lg-3 col-xl-3">
                    ...
                    <div class="footer__widget--inner">
                        <p class="footer__widget--desc text-ofwhite m-0">
                            Take advantage of our special offer. <br>Do not worry, we would not spam you.
                        </p>
