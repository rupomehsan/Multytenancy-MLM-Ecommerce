    ...
    <section class="shop__section">
        <div class="container-fluid">
            <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                ...
                <p class="product__showing--count">Showing {{ ($products->currentpage() - 1) * $products->perpage() + 1 }}
                    - {{ $products->currentpage() * $products->perpage() }} of {{ $products->total() }} results</p>
            </div>
                    ...
                    <div class="">
                        <div class="shop__banner--area mb-30">
                            @if ($firstParam === 'category' && $category_banner && $category_banner->banner_image)
                                <img src="{{ env('ADMIN_URL') . '/' . $category_banner->banner_image }}" alt="banner"
                            ...
                            @elseif ($firstParam === 'brand' && $brand_banner && $brand_banner->banner)
                                <img src="{{ env('ADMIN_URL') . '/' . $brand_banner->banner }}" alt="banner"
                                    class="img-fluid" style="max-height: 300px; width: 100%; object-fit: cover;">
                            @endif
                        </div>
