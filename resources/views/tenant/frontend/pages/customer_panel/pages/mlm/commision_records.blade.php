...
@section('dashboard_content')
    ...
    <div class="mlm-page-header">
        <h1><i class="fi-rr-sack-dollar"></i> Commission History</h1>
    ...
    <div class="mlm-content-card">
        ...
        <div class="mlm-card-header">
            ...
            <div style="display: flex; gap: 12px;">
                <button class="mlm-btn mlm-btn-outline" onclick="exportCommissions()">
                    <i class="fi-rr-download"></i> Export
                </button>
                <button class="mlm-btn mlm-btn-primary"
                    onclick="window.location.href='{{ url('/customer/mlm/withdrawal-requests') }}'">
                    <i class="fi-rr-wallet"></i> Request Withdrawal
                </button>
            </div>
        </div>
