                    ...
                    <div class="col-lg-12">
                        <div class="guest_order_alert">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <p class="m-0">Have any account? please login or register</p>
                                </div>
                                <div class="col-lg-6 text-end">
                                    <a href="{{ url('/login') }}" class="d-inline-block">Login</a>
                                    <a href="{{ url('/register') }}" class="d-inline-block">Register</a>
                                </div>
                            </div>
                        </div>
                    </div>
