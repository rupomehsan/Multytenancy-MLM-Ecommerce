                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <span class="h3 mb-0"> <a target="_blank" href="{{ url('view/pending/orders') }}"
                                    style="height: 20px; line-height: 10px; margin-top: -4px;"
                                    class="btn btn-sm btn-success rounded">View All</a> </span>
                        </div>
                    </div> <!-- end row -->
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-subtitle mb-4">From date of {{ date('jS M, Y', strtotime($queryStartDate)) }} to continue
                    </p>
